/**
 * Reusable UI primitive for Menubar.
...
>(({ className, inset, children, ...props }: { inset?: boolean } & React.ComponentPropsWithoutRef<typeof MenubarPrimitive.SubTrigger>, ref) => (
...
>(({ className, inset, ...props }: { inset?: boolean } & React.ComponentPropsWithoutRef<typeof MenubarPrimitive.Item>, ref) => (
...
>(({ className, inset, ...props }: { inset?: boolean } & React.ComponentPropsWithoutRef<typeof MenubarPrimitive.Label>, ref) => (
