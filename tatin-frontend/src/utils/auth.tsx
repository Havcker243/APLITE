...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const stored = (typeof window !== "undefined" && window.localStorage.getItem("tatin_auth_storage")) || "local";
  ...
  const handleLogout = () => {
    ...
    void signOut.finally(() => {
      ...
      if (typeof window !== "undefined") {
        try {
          window.sessionStorage.removeItem("tatin_onboarding_session_v2"); // clear onboarding draft/progress
        } catch {
