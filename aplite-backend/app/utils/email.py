...
def send_onboarding_submitted(to_address: str, first_name: str, legal_name: str) -> None:
    subject = "Your Tatin verification has been submitted"
    body = (
        f"Hi {first_name},\n\n"
...
def send_onboarding_approved(to_address: str, first_name: str, legal_name: str, upi: str) -> None:
    subject = "Your Tatin verification is approved"
    body = (
        f"Hi {first_name},\n\n"
        f"Great news - {legal_name} has been verified on Tatin.\n\n"
        f"Your UPI: {upi}\n\n"
    ...
    html = (
        f"<p>Hi {first_name},</p>"
        f"<p>Great news - <strong>{legal_name}</strong> has been verified on Tatin.</p>"
...
def send_onboarding_rejected(to_address: str, first_name: str, legal_name: str, reason: str) -> None:
    subject = "Update on your Tatin verification"
    body = (
        f"Hi {first_name},\n\n"
