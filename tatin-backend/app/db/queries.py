"""
Data-access helpers for the Tatin backend.
...
def send_verification_message_email(*, to_address: str, code: str) -> None:
    ...
    send_email(to_address=to_address, subject="Your Tatin verification code", body=f"Your verification code is {code}. It expires in 10 minutes.")
