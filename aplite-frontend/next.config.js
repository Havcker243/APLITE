...
const csp = [
  ...
  "font-src 'self' data:",
  "connect-src 'self' https://app.cal.com https://cal.com https://api.cal.com https://dkmiberadlbashogpdrp.supabase.co https://*.supabase.co https://tatin-2.onrender.com " + apiOrigin,
