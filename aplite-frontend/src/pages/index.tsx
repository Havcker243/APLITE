...
export default function LandingPage() {
  ...
  const [tatimId, setTATIMId] = useState("bulldogbites@tatim");

  function handleVerify(e: React.FormEvent) {
    e.preventDefault();
    const trimmed = tatimId.trim();
    if (!trimmed) return;
      ...
      <section className="pt-40 pb-24 px-6">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-12">
            Before wiring money to a new vendor, check their TATIM ID. Instantly
          ...
          <form onSubmit={handleVerify} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
            <Input
              value={tatimId}
              onChange={(e) => setTATIMId(e.target.value)}
          ...
          <p className="text-sm text-muted-foreground mt-4">
            ...
            <button
              ...
              onClick={() => setTATIMId("bulldogbites@tatim")}
            >
              bulldogbites@tatim
            </button>
            {" · "}
            <button
              type="button"
              className="font-mono underline underline-offset-2 hover:text-foreground transition-colors"
              onClick={() => setTATIMId("fastfreight@tatim")}
            >
              fastfreight@tatim
            </button>
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-card border border-success/30 rounded-xl p-6 shadow-card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-success">TATIM confirmed</p>
                </div>
              </div>
            ...
            <div className="bg-card border border-destructive/30 rounded-xl p-6 shadow-card">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                We could not verify this business. This ID is not registered in the TATIM network.
              </p>
              <button
                type="button"
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-8">
            <Step
              number="01"
              title="Get the TATIM ID"
              description="When paying a new vendor, ask them for their TATIM ID. It looks like: businessname@tatim"
            />
            <Step
              number="02"
              title="Check it here"
              description="Enter the ID above. TATIM instantly tells you if this business has been verified by our team."
            />
            <Step
              number="03"
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <SecurityCard
              ...
              description="TATIM IDs are generated via HMAC with a per-deployment secret. They are not guessable or enumerable."
            />
            <SecurityCard
              title="Rate limited"
      ...
      <footer className="py-10 px-6 border-t border-border">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
            <p className="text-sm text-muted-foreground">© 2026 TATIM. Payment identity verification.</p>
