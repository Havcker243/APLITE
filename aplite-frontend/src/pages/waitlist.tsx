...
export default function WaitlistPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        <title>Join the Waitlist — TATIM</title>
        <meta name="description" content="Get early access to TATIM — verified payment identity for businesses." />
      </Head>
        ...
        <div className="container mx-auto max-w-2xl">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold text-foreground leading-tight mb-4">
              Be first to know<br />
              <span className="text-muted-foreground">when TATIM opens.</span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-lg mx-auto">
              TATIM gives businesses a verified payment identity so partners know
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Feature
              ...
              description="Every business is manually verified before a TATIM ID is issued."
            />
            <Feature
      ...
      <footer className="py-8 px-6 border-t border-border">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">TATIM</span>
          </div>
