...
export default function PaymentIdentityPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle relative overflow-hidden">
      <Head>
        <title>Why Payment Identity Matters - TATIM</title>
      </Head>
      ...
      <main className="mx-auto w-full max-w-5xl px-6 py-12">
        <div className="mb-10 rounded-lg border border-border bg-background/80 p-8 shadow-card backdrop-blur">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            ...
            detail is updated without strong verification. The result is avoidable risk. TATIM replaces that ambiguity
        ...
        <div className="mt-10 space-y-6 text-sm text-muted-foreground leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-base font-semibold text-foreground">TATIM's approach</h2>
            <p>
